...
// SetMusicLabels sets the labels, Major have a scale and a drone, while minor
// have melodic and harmonic minor scales.
...
// changeSharpToS deletes the last character and replace it with s
// if the img or audio path contain #.
